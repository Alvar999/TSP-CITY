...
hook OnGameModeInit()
{
    ...
    Bank_TD[0] = TextDrawCreate(88.3674, 51.7498, "LD_SPAC:white"); // �����
    ...
    Bank_TD[1] = TextDrawCreate(98.6747, 39.4998, "LD_SPAC:white"); // �����
    ...
    Bank_TD[2] = TextDrawCreate(523.6245, 33.0833, "LD_BEAT:chit"); // �����
    ...
    Bank_TD[3] = TextDrawCreate(83.2138, 33.0833, "LD_BEAT:chit"); // �����
    ...
    Bank_TD[4] = TextDrawCreate(523.6245, 358.5830, "LD_BEAT:chit"); // �����
    ...
    Bank_TD[5] = TextDrawCreate(83.2138, 358.5833, "LD_BEAT:chit"); // �����
    ...
    Bank_TD[6] = TextDrawCreate(106.6396, 60.4998, "LD_SPAC:white"); // �����
    ...
    Bank_TD[7] = TextDrawCreate(138.1990, 66.3332, "VAE_Bank"); // �����
    ...
    Bank_TD[8] = TextDrawCreate(106.6398, 60.4998, "LD_SPAC:white"); // �����
    ...
    Bank_TD[9] = TextDrawCreate(325.4386, 60.4998, "LD_SPAC:white"); // �����
    ...
    Bank_TD[10] = TextDrawCreate(309.2095, 42.9998, "/"); // �����
    ...
    Bank_TD[11] = TextDrawCreate(316.7059, 42.9998, "/"); // �����
    ...
    Bank_TD[12] = TextDrawCreate(384.6416, 70.4166, "So Tai Khoan"); // �����
    ...
    Bank_TD[13] = TextDrawCreate(390.2633, 80.3331, "7-777-777-77-77"); // �����
    ...
    Bank_TD[14] = TextDrawCreate(380.8927, 82.0831, "+"); // �����
    ...
    Bank_TD[15] = TextDrawCreate(124.6119, 111.2499, "TAI KHOAN NGAN HANG"); // �����
    ...
    Bank_TD[16] = TextDrawCreate(106.6398, 132.8332, "LD_SPAC:white"); // �����
    ...
    Bank_TD[17] = TextDrawCreate(106.6398, 191.1663, "LD_SPAC:white"); // �����
    ...
    Bank_TD[18] = TextDrawCreate(106.6398, 248.9165, "LD_SPAC:white"); // �����
    ...
    Bank_TD[19] = TextDrawCreate(106.6398, 307.2499, "LD_SPAC:white"); // �����
    ...
    Bank_TD[20] = TextDrawCreate(322.6278, 132.2498, "LD_SPAC:white"); // �����
    ...
    Bank_TD[21] = TextDrawCreate(322.6278, 190.5832, "LD_SPAC:white"); // �����
    ...
    Bank_TD[22] = TextDrawCreate(322.6278, 248.3332, "LD_SPAC:white"); // �����
    ...
    Bank_TD[23] = TextDrawCreate(322.6278, 306.6665, "LD_SPAC:white"); // �����
   ...
   /* Bank_TD[24] = TextDrawCreate(227.2180, 147.9996, "BALANCE: 100000$"); // �����
    ...
    Bank_TD[25] = TextDrawCreate(227.2180, 206.3332, "CHUYEN TIEN"); // �����
    ...
    Bank_TD[26] = TextDrawCreate(227.2180, 264.0831, "RUT TIEN"); // �����
    ...
    Bank_TD[27] = TextDrawCreate(227.2180, 322.4168, "GUI TIEN"); // �����
    ...
    Bank_TD[29] = TextDrawCreate(443.2066, 206.3332, "SO TIEN: 12314124$"); // �����
    ...
    Bank_TD[30] = TextDrawCreate(443.2066, 264.0834, "CHAP NHAN"); // �����
    ...
    Bank_TD[31] = TextDrawCreate(443.2066, 322.4168, "DONG"); // �����
    ...
    Bank_TD[32] = TextDrawCreate(338.5577, 262.9166, "LD_SPAC:white"); // �����
    ...
    Bank_TD[33] = TextDrawCreate(338.5577, 321.2500, "LD_SPAC:white"); // �����
    ...
    Bank_TD[34] = TextDrawCreate(338.5577, 146.2498, "LD_SPAC:white"); // �����
    ...
    Bank_TD[35] = TextDrawCreate(338.5577, 204.5832, "LD_SPAC:white"); // �����
    ...
    Bank_TD[36] = TextDrawCreate(122.5690, 262.9165, "LD_SPAC:white"); // �����
    ...
    Bank_TD[37] = TextDrawCreate(122.5690, 321.2500, "LD_SPAC:white"); // �����
    ...
    Bank_TD[38] = TextDrawCreate(122.5690, 146.2498, "LD_SPAC:white"); // �����
    ...
    Bank_TD[39] = TextDrawCreate(122.5690, 204.5830, "LD_SPAC:white"); // �����
    ...
    Bank_TD[40] = TextDrawCreate(125.8491, 151.4998, "hud:radar_cash"); // �����
    ...
    Bank_TD[41] = TextDrawCreate(125.3805, 210.4165, "LD_BEAT:right"); // �����
    ...
    Bank_TD[42] = TextDrawCreate(125.3805, 269.3334, "LD_BEAT:right"); // �����
    ...
    Bank_TD[43] = TextDrawCreate(125.3805, 327.0834, "LD_BEAT:right"); // �����
    ...
    Bank_TD[44] = TextDrawCreate(341.3692, 151.4998, "hud:radar_propertyG"); // �����
    ...
    Bank_TD[45] = TextDrawCreate(341.3692, 268.1668, "hud:radar_saveGame"); // �����
    ...
    Bank_TD[46] = TextDrawCreate(341.3692, 209.8332, "hud:radar_triads"); // �����
    ...
    Bank_TD[47] = TextDrawCreate(343.4114, 322.9999, "X"); // �����
...
hook OnPlayerConnect(playerid)
{
    ...
    Bank_PlayerTD[0] = CreatePlayerTextDraw(playerid,443.2066, 206.3332, ""); // �����
    ...
    Bank_PlayerTD[2] = CreatePlayerTextDraw(playerid,227.2180, 147.9996, "BALANCE: 100000$"); // �����
...
hook OnPlayerDisconnect(playerid, reason)
{
	...
	if(MobilePlayer[playerid][calling] == 1 || MobilePlayer[playerid][calling] == 2) cmd_tatdienthoai(playerid, "");
	return 1;
}
...
CMD:modienthoai(playerid, params[])
{
...
CMD:goidienthoai(playerid, params[])
{
...
CMD:tatdienthoai(playerid, params[])
{
		if(MobilePlayer[playerid][calling] == 1)
		{
		    KillTimer(TimerWaitCalling[MobilePlayer[playerid][caller]]);
